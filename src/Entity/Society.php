...
class Society
{
    ...
    #[ORM\OneToMany(targetEntity: Project::class, mappedBy: 'society', cascade: ['persist', 'remove'])]
    private Collection $projects;

    #[Vich\UploadableField(mapping: 'society_illustration', fileNameProperty: 'logoName')]
